...
export PATH="/Users/alexmerenda/.bin:/usr/local/opt/python/libexec/bin:/Users/alexmerenda/Library/Python/3.7/bin:/usr/local/bin:$(brew --prefix openvpn)/sbin:$PATH"
