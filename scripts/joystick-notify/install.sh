...
sudo install -Dm0755 "$ROOT/joystick-tray.py" /usr/local/bin/joystick-notify-tray
...
install -Dm0644 "$ROOT/joystick-notify-tray.desktop" "$HOME/.local/share/applications/joystick-notify-tray.desktop"
